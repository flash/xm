...
rr.styles('tmpl:maibox_row'
	, '.b-mbox_row {position:relative;margin:0;padding: 0px 120px 0px 60px; white-space: nowrap;line-height:30px; height:30px; border-bottom:1px solid #B6E1F3;}'
	...
	, '.b-mbox_row-link {display: inline-block;color:#575757;overflow: hidden;max-width:100%;}' // not work -o-text-overflow: ellipsis; text-overflow: ellipsis;
	, '.b-mbox_row-from {display:inline-block;color: #575757;font-size: 12px;}'
	, '.b-mbox_row-subj {display:inline-block;margin-left: 10px;color:#000; font-size: 13px;}'  
